...
The script bumps Info.plist version, builds + signs + notarizes the DMG, generates the Sparkle appcast, uploads to the website, commits, tags, and pushes to both remotes (public).
