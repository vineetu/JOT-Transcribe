...
/// Router that sorts a user's spoken rewrite instruction into one of four
/// branches so `LLMClient.rewrite(…)` can pick a specialized system prompt.
///
...
enum RewriteBranch: String, Sendable {
